...
import styles from "./popularSongItem.module.scss";
...
const PopularSongItems = ({ playlist, song, handleRemoveSong }) => {
  ...
  return (
    <div className={styles.song_container}>
      ...
      <div className={styles.center}>
        <p className="link">{song.totalListener}</p>
      </div>
...
export default PopularSongItems;
