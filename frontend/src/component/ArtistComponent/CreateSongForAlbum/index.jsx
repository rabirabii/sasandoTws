...
import { createSongAlbum } from "../../../redux/actions/album";
import axios from "axios";

const CreateSongForAlbum = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Selected Album ID:", album);
    ...
    newForm.append("albumId", albums._id); // Append the selected album ID
    dispatch(createSongAlbum(newForm));
  };

  useEffect(() => {
    const fetchYourAlbum = async () => {
      try {
        const response = await axios.get(`${server}/album/yourAlbum`, {
          withCredentials: true,
        });
        const fetchedAlbums = response.data.albums || []; // Handle potential undefined or null response
...
export default CreateSongForAlbum;
